...
__all__ = ['_load_file', '_save_file', '_get_node_info', '_frame_euclidian_coordiantes',
           '_sun_position_coordinates', '_sun_occlusion_coordinates', '_normalize_infrared_image',
           '_cloud_pixels_labeling', '_polar_coordinates_transformation', '_cart_to_polar',
           '_sun_pixels_interpolation', '_geometric_coordinates_transformation', '_clouds_mass_center',
           '_atmospheric_effect', '_potential_lines', '_streamlines', '_vorticity', '_divergence',
           '_magnitude', '_index_velocity_vectors', '_cloud_velocity_field_processing', '_pixels_selection',
           '_calculate_features_statistics']
